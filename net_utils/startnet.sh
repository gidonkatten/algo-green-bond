...
${gcmd} account import -m "rose mistake rely negative offer position another teach company aspect bar tree simple gauge donate physical exclude slam prison carpet another distance curtain able gun"

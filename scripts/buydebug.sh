...
${gcmd} clerk send --from=$ACCOUNT2 --to=$ACCOUNT --fee=1000 --amount=5000000 --out=unsignedtransaction2.tx
${gcmd} asset send --from=$ACCOUNT --to=$ACCOUNT2  --creator ${ACCOUNT} --assetid ${ASSETID} --fee=1000 --amount=1 --out=unsignedtransaction3.tx
...
tealdbg debug ../src/approval_program.teal -d dr.msgp --group-index 0
